		...
		light: {
			palette: {
				...
				background: {
					...
					level1: "var(--mui-palette-success-50)", //"var(--mui-palette-neutral-50)",
					level2: "var(--mui-palette-success-100)", //"var(--mui-palette-neutral-100)",
					level3: "var(--mui-palette-success-200)", //"var(--mui-palette-neutral-200)",
				},
				common: { black: "#000000", white: "#ffffff" },
				divider: "var(--mui-palette-success-200)",
